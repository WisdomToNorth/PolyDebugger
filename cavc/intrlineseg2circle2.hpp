                                                    ...
                                                    Vector2<Real> const &circleCenter)
{
    ...
    // + t * (v2.X - v1.X) and y = v1.Y + t * (v2.Y - v1.Y) for t = 0 to t = 1 into the circle
    // equation (x-h)^2 + (y-k)^2 = r^2 and then solving the resulting equation in the form a*t^2 +
    // b*t + c = 0 using the quadratic formula
