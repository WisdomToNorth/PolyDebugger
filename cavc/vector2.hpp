...
template <typename Real>
Real perpDot(Vector2<Real> const &v0, Vector2<Real> const &v1)
{
...
template <typename Real>
Real distSquared(Vector2<Real> const &p0, Vector2<Real> const &p1)
{
...
template <typename Real>
Real angle(Vector2<Real> const &p0, Vector2<Real> const &p1)
{
...
template <typename Real>
Vector2<Real> midpoint(Vector2<Real> const &p0, Vector2<Real> const &p1)
{
