...
typedef std::function<double(const Path64 &path, const PathD &path_normals, size_t curr_idx,
                             size_t prev_idx)>
    DeltaCallback64;
...
public:
    explicit ClipperOffset(double miter_limit = 2.0, double arc_tolerance = 0.0,
        ...
        arc_tolerance_(arc_tolerance), preserve_collinear_(preserve_collinear),
