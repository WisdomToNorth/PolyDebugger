...
bool GetInt(string::const_iterator &s_it, const string::const_iterator &it_end, int64_t &value)
{
    value = 0;
    while (s_it != it_end && *s_it == ' ')
        ++s_it;
    if (s_it == it_end)
        return false;
    bool is_neg = (*s_it == '-');
...
bool LoadTestNum(ifstream &source, int test_num, Paths64 &subj, Paths64 &subj_open, Paths64 &clip,
