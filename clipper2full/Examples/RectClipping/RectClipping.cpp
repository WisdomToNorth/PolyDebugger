...
Path64 MakeRandomEllipse(int minWidth, int minHeight, int maxWidth, int maxHeight, int maxRight,
                         int maxBottom)
{
...
Path64 MakeRandomRectangle(int minWidth, int minHeight, int maxWidth, int maxHeight, int maxRight,
                           int maxBottom)
{
    int w = maxWidth > minWidth ? minWidth + rand() % (maxWidth - minWidth) : minWidth;
    int h = maxHeight > minHeight ? minHeight + rand() % (maxHeight - minHeight) : minHeight;
