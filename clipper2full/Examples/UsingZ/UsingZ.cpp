...
public:
    ...
    void myZCB(const Point64 &e1bot, const Point64 &e1top, const Point64 &e2bot,
    ...
    void myZCBD(const PointD &e1bot, const PointD &e1top, const PointD &e2bot, const PointD &e2top,
                PointD &pt)
    {
        pt.z = 1;
    }
...
void TestingZ_Int64()
{
    ...
    c64.SetZCallback(std::bind(&MyClass::myZCB, mc, std::placeholders::_1, std::placeholders::_2,
...
void TestingZ_Double()
{
    ...
    c.SetZCallback(std::bind(&MyClass::myZCBD, mc, std::placeholders::_1, std::placeholders::_2,
