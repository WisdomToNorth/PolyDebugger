...
void test1()
{
    ...
    ClipperOffset co;
    co.SetDeltaCallback(
        [delta](const Path64 &path, const PathD &path_norms, size_t curr_idx, size_t prev_idx)
        {
...
void test3()
{
    ...
    co.SetDeltaCallback(
        [radius](const Path64 &path, const PathD &path_norms, size_t curr_idx, size_t prev_idx)
        {
...
void test4()
{
    ...
    co.Execute(
        [scale](const Path64 &path, const PathD &path_norms, size_t curr_idx, size_t prev_idx)
        {
...
void test5()
{
    ...
    co.Execute([](const Path64 &path, const PathD &path_norms, size_t curr_idx, size_t prev_idx)
