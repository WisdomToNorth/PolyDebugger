...
void DoBenchmark(int edge_cnt_start, int edge_cnt_end, int increment, bool test_polytree = false);
...
void DoBenchmark(int edge_cnt_start, int edge_cnt_end, int increment, bool test_polytree)
{
    ...
    if (test_polytree)
        solution = PolyTreeToPaths64(polytree);
